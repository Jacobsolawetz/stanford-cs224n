...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        self.input_placeholders = tf.placeholder(tf.float32, shape = [Config.batch_size,Config.n_features])
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None):
        ...
        """
        feed_dict = {self.input_placeholders: inputs_batch, self.labels_placeholder: labels_batch}
    ...
    def add_prediction_op(self):
        ...
        """
        #self.input_placeholders [batch_size, n_features]
        ...
        pred = softmax(tf.matmul(self.input_placeholders,W) + b)
